...
class bPACMetricsEvaluator:
    def __init__(self, root):
        ...
        self.checkbox_columns = ['Derippling', 'Segmentation', 'HQ Exp', 'bPAC pos', 'TBD', 'To fix', 'Export']
